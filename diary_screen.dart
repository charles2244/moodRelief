...
//import '../services/controller/diary_controller.dart' hide DiaryEntry;
...
class _DiaryScreenState extends State<DiaryScreen> {
  ...
  Future<void> loadFilteredDDiary() async {
    try {
      ...
      _userId = userId;
      final diaries = await _diaryService.fetchDiaryByDate(userId: userId, selectedDate: DateTime.now());

      //print achievement title
      final achievementResult = await _diaryService.checkAchievement(_userId!);
  ...
  //   for (var achievement in achievementData) {
  //     if (!achievedIds.contains(achievement['id'])) {
  //       return {'title': achievement['achievement_title']}; // New achievement unlocked!
  //     }
  //   }
  //
